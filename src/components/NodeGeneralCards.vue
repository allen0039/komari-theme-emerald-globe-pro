...
const compactGlobe = useMediaQuery('(max-width: 767px)')
...
<template>
  <div :class="wrapperClass">
    <NodeEarthGlobe v-if="showEarth" :nodes="globeNodes" :compact="compactGlobe" class="col-span-12 col-start-1 md:col-span-6 md:col-start-7" />
        ...
        >
          <div class="flex h-full min-w-0 flex-col overflow-hidden">
            ...
            <div class="shrink-0 flex flex-col flex-1">
              ...
              <div class="grid h-14 auto-rows-4 grid-cols-2 gap-x-4 gap-y-1 overflow-auto">
                <div
