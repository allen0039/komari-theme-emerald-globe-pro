...
import NodePingNetworkSummaryRow from '@/components/NodePingNetworkSummaryRow.vue'
...
<template>
  <CardX
    ...
    header-class="gap-1.5 px-3 py-2 sm:gap-2 sm:px-4 sm:py-3"
  ...
  >
    ...
    <template #default>
      <div class="flex flex-col gap-2.5 sm:gap-3">
        <div class="gap-x-2.5 gap-y-1 grid grid-cols-2 sm:gap-x-3">
          <!-- CPU -->
